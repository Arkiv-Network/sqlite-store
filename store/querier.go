...
type Querier interface {
	DeleteNumericAttributesBeforeBlock(ctx context.Context, fromBlock int64) error
	DeletePayloadsBeforeBlock(ctx context.Context, fromBlock int64) error
	DeleteStringAttributesBeforeBlock(ctx context.Context, fromBlock int64) error
